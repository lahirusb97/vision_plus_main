  ...
  return (
    <Box>
      <PatientSearchOnType
        ...
        createPatientBtnLable="Register Patient & Create a Channel"
      ...
      <PatientTable
        ...
        existingPatinetBtnLable="Create a Channel for "
        onRawSelect={(row) => {
          navigate(`/channel/${row.id}/channel-create`);
        }}
      ...
      <PatientCreateDialog
        ...
        onSuccess={(data) => {
          ...
          navigate(`/channel/${data.id}/channel-create`);
        }}
      />
      {editPatient && (
        <PatientUpdateDialog
