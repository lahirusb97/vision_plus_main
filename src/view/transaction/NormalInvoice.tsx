...
import { Box, Typography, Paper, TextField, MenuItem, Button, Radio, RadioGroup, FormControlLabel } from "@mui/material";
...
const TransactionUI = () => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", gap: 2, marginBottom: 2,marginLeft:4, marginRight:4 }}>
    ...
    <Box display="flex" flexDirection="row" gap={10} marginLeft="50px">
      ...
      {/* Save Button */}
      <Box sx={{ display: "flex", justifyContent: "right", marginRight:"30px" }}>
        <Button variant="contained" color="secondary" sx={{ backgroundColor: "#D4B4DC" }}>
          Save
        </Button>
      </Box>
    </Box>
