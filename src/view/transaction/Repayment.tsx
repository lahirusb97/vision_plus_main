...
const PaymentUI = () => {
  ...
  const handleSecondPaymentChange = (event) => {
  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, p: 4, borderRadius: 2, width: "800px",  }}>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
        <Paper sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 2, width: "100%" }}>
      ...
      >
        {/* Full Amount */}
        <Paper sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 2 }}>
          <Typography sx={{ fontSize: 16 }}>Full Amount</Typography>
      ...
      <Box mt={4} textAlign="center">
        <Button variant="contained" color="primary" onClick={handleSave} sx={{ backgroundColor:"#D4B4DC" }}>
          Save
        </Button>
      </Box>
    </Container>
