...
import useGetHearingReminderList from "../../../hooks/useGetHearingReminderList";
import { RefreshCwIcon, Search } from "lucide-react";
export default function HearingReminder() {
  ...
  const {
    hearingReminderList,
    hearingReminderListChangePageSize,
    hearingReminderListPageNavigation,
    hearingReminderListTotalCount,
    hearingReminderListSearch,
    hearingReminderListLoading,
    hearingReminderListError,
    hearingReminderLimit,
    hearingReminderListRefres,
  } = useGetHearingReminderList();
      ...
      >
        ...
        <Button
          ...
          onClick={() => {
            ...
            hearingReminderListSearch(params);
          }}
        >
          Service Date
        </Button>
      ...
      <TableContainer component={Paper}>
        {hearingReminderListLoading ? (
          ...
          <Table>
            ...
            <TableBody>
              {hearingReminderList?.length > 0 ? (
                hearingReminderList.map((invoice) => (
        ...
        <CustomerPagination
          totalCount={hearingReminderListTotalCount}
          handlePageNavigation={hearingReminderListPageNavigation}
          changePageSize={hearingReminderListChangePageSize}
          page_size={hearingReminderLimit}
        />
        <ConfirmDialog
