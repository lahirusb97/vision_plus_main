...
import InvoiceHearingDetails from "../../components/Invoice/InvoiceHearingDetails";

const HearingInvoiceView = () => {
...
export default HearingInvoiceView;
