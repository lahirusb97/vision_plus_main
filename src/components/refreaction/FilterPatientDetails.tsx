...
export default function FilterPatientDetails({
  open,
  searchType,
  handleClose,
  onPatientSelect,
    ...
    if (open) {
      if (searchType === "phone_number") {
        PatientListSearch({
          ...
          nic: null,
          search: null,
          phone_number: watch("customer_mobile"),
        });
        ...
        PatientListSearch({
          ...
          page: 1,
          nic: null,
          search: watch("customer_full_name"),
          phone_number: null,
        });
  ...
  const handleSave = async (id: number) => {
    ...
    try {
      ...
      setEditedPatient({});
      setValue("customer_full_name", response.data.name);
      setValue("customer_mobile", response.data.phone_number);
